    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          '28 إعداداً مسبقاً جاهزاً',
          'أكثر من 70 مرشح معالجة',
  ...
  'gpr-program': {
    ...
    sections: [
      ...
      },
      {
        title: 'لماذا SubScan؟',
        paragraphs: [
          '28 إعداداً مسبقاً وأكثر من 70 مرشحاً للمعالجة. إصدار Android للميدان وإصدار سطح المكتب للتحليل المتقدم. توافق SGY مع Tork GPR.',
        ],
      },
    ],
    cta: {
